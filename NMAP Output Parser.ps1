...
$directory = "D:\nmap_ps_parser\leon_county_full\"
...
Write-host "Completed analysis for "$total_hosts" hosts in this scan:"
Write-host $resp_hosts.count "Responded with a non zero ttl packet."
Write-host $resp_open_hosts.count  " Responded with open ports."
...
#create uplist
$resp_ports
$resp_hosts.ipv4_Address | out-file 
